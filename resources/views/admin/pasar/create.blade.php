            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="tipe_pasar" required>
                        ...
                        <option value="tradisional" {{ old('tipe_pasar') == 'tradisional' ? 'selected' : '' }}>Tradisional</option>
                        <option value="modern" {{ old('tipe_pasar') == 'modern' ? 'selected' : '' }}>Modern</option>
                        <option value="lainnya" {{ old('tipe_pasar') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                    </select>
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea
                        ...
                        required
                        placeholder="Tambahkan keterangan tambahan seperti lokasi pasar dekat dengan fasilitas bangunan apa saja...">{{ old('keterangan') }}</textarea>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        let actionUrl = "{{ route('admin.pasar.store') }}";
