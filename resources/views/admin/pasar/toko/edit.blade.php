                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input
                            ...
                            value="{{ old('nama_pemilik_toko', $toko->nama_pemilik_toko) }}"
                            required>
                    </div>
                    <small class="text-muted">Masukkan nama toko</small>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input
                            ...
                            value="{{ old('nomor_kios', $toko->nomor_kios) }}">
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        let actionUrl = "{{ route('admin.pasar.toko.update', [$pasar->id, $toko->id]) }}";
